...
public class PlayerActionWalk {
  ...
  public Topology buildTopology(final Properties envProps,
    ...
    builder.stream(inputTopic, Consumed.with(Serdes.String(), playerActionSerde))
        // chave será nome e valor será o tanto de KM andado
        .map((k, v) -> new KeyValue<>((String) v.getPlayer().getPlayerName(), (Integer) v.getWalk().getDistance()))
  ...
  public static void main(final String[] args) throws IOException {
    ...
    new PlayerActionWalk().runRecipe(args[0]);
  }
  ...
  private void runRecipe(final String configPath) throws IOException {
    ...
    try {
      System.out.println("****** iniciando o analisador de stream de caminhada ******");
